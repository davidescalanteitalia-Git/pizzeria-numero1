...
const FILES = [
  ...
  './icon-tonno.webp',
  './icon-bufala.webp',
  './icon-prosciutto.webp',
  './icon-acciughe.webp',
  './icon-aglio.webp',
  './icon-capperi.webp',
  './icon-carciofi.webp',
  './icon-cipolla.webp',
  './icon-cipolla-rossa.webp',
  './icon-fagioli.webp',
  './icon-grana.webp',
  './icon-mais.webp',
  './icon-melanzane.webp',
  ...
  './icon-pancetta.webp',
  './icon-panna.webp',
  './icon-patatine-fritte.webp',
  './icon-peperoncino.webp',
  './icon-peperoni.webp',
  './icon-pomodoro.webp',
  './icon-rucola.webp',
  './icon-salame-dolce.webp',
  './icon-salsiccia.webp',
  './icon-scamorza.webp',
  './icon-taleggio.webp',
  './icon-uovo.webp',
